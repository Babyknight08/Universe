...
class Records {	
	...
	public $Water_ValidDP;
	public $Water_ValidDPText;
	public $Water_VolumeDP;
	public $Water_VolumeDPText;
	public $Water_PermitsComplied;
	public $Water_PermitsCompliedText;
	public $Water_FlowMeterDevice;
	public $Water_FlowMeterDeviceText;
	public $Water_CertifiedSiphoning;
	public $Water_CertifiedSiphoningText;
	public $Water_ComplianceEffluent;
	public $Water_ComplianceEffluentText;
	public $Water_AmbientQualityMonitoring;
	...
	public $SWM_WasteDisposalFacilitiesText;
	public $PCO_Guidelines;
	...
	public function updateRecord(){
		...
		if($this->id) {	
			...
			$this->Water_ValidDP= htmlspecialchars(strip_tags($this->Water_ValidDP));
			$this->Water_ValidDPText= htmlspecialchars(strip_tags($this->Water_ValidDPText));
			$this->Water_VolumeDP= htmlspecialchars(strip_tags($this->Water_VolumeDP));
			$this->Water_VolumeDPText= htmlspecialchars(strip_tags($this->Water_VolumeDPText));
			$this->Water_PermitsComplied= htmlspecialchars(strip_tags($this->Water_PermitsComplied));
			$this->Water_PermitsCompliedText= htmlspecialchars(strip_tags($this->Water_PermitsCompliedText));
			$this->Water_FlowMeterDevice= htmlspecialchars(strip_tags($this->Water_FlowMeterDevice));
			$this->Water_FlowMeterDeviceText= htmlspecialchars(strip_tags($this->Water_FlowMeterDeviceText));
			$this->Water_CertifiedSiphoning= htmlspecialchars(strip_tags($this->Water_CertifiedSiphoning));
			$this->Water_CertifiedSiphoningText= htmlspecialchars(strip_tags($this->Water_CertifiedSiphoningText));
			$this->Water_ComplianceEffluent= htmlspecialchars(strip_tags($this->Water_ComplianceEffluent));
			$this->Water_ComplianceEffluentText= htmlspecialchars(strip_tags($this->Water_ComplianceEffluentText));
			$this->Water_AmbientQualityMonitoring= htmlspecialchars(strip_tags($this->Water_AmbientQualityMonitoring));
			$this->Water_AmbientQualityMonitoringText= htmlspecialchars(strip_tags($this->Water_AmbientQualityMonitoringText));
			$this->Water_PaymentWastewater= htmlspecialchars(strip_tags($this->Water_PaymentWastewater));
			$this->Water_PaymentWastewaterText= htmlspecialchars(strip_tags($this->Water_PaymentWastewaterText));
			$this->SWM_WasteSegregation= htmlspecialchars(strip_tags($this->SWM_WasteSegregation));
			$this->SWM_WasteSegregationText= htmlspecialchars(strip_tags($this->SWM_WasteSegregationText));
			$this->SWM_WasteDisposalFacilities= htmlspecialchars(strip_tags($this->SWM_WasteDisposalFacilities));
			$this->SWM_WasteDisposalFacilitiesText= htmlspecialchars(strip_tags($this->SWM_WasteDisposalFacilitiesText));
	...
	public function createRecord(){
		...
		if($this->name) {
			...
			$uniqueid = uniqid();
			$targetPath = $this->targetPath . $uniqueid;
			
		
			$query = "
			INSERT INTO ".$this->tblreports."(`ID`,`Reportcontrol`,`DateofInspection`,`MissionOrder`,`ReportPD1586`,`ReportRA6969`,`ReportRA8749`,`ReportRA9275`,`ReportRA9003`,`ProjectName`,`SpecificAddress`,`NatureofBusiness`,`PSIC`,`Product`,`Latitude`,`Longitude`,`YearEstablished`,`PCOName`,`OperatingDay`,`OperatingWeek`,`OperatingYear`,`Product_Line`,`ProdRateECCDeclared`,`ActualProdRate`,`ManagingHead`,`PCOAccreditation`,`PCOA_Date`,`ContactNumber`,`EmailAddress`,`VerifyAccuracy`,`PMPIN_Hazardous`,`HWIDRegistration`,`HWTRegistration`,`HWTSDRegistration`,`PTOAPCI`,`DischargePermit`,`OthersPV`,`OthersPV_text`,`DetermineCompliance`,`InvestigateComplaints`,`StatusCommitments`,`EwatchProgram`,`PEPP`,`PAB`,`Others`,`Others_Text`,`ECC`,`ECC_DOI`,`ECC_DE`,`DENRID`,`DENRID_DOI`,`DENRID_DE`,`PCL_Compliance`,`PCL_Compliance_DOI`,`PCL_Compliance_DE`,`CCO_Registry`,`CCO_Registry_DOI`,`CCO_Registry_DE`,`Importation_Clearance`,`Importation_Clearance_DOI`,`Importation_Clearance_DE`,`COT_Issued`,`COT_Issued_DOI`,`COT_Issued_DE`,`TSD_RegistrationCert`,`TSD_RegistrationCert_DOI`,`TSD_RegistrationCert_DE`,`POA_No`,`POA_No_DOI`,`POA_No_DE`,`Discharge_Permit`,`Discharge_Permit_DOI`,`Discharge_Permit_DE`,`MOA_Agreement`,`MOA_Agreement_DOI`,`MOA_Agreement_DE`,`ECC_Condition`,`ECC_ConditionSelect`,`ECC_ConditionRemarks`,`Haz_PCLCompliance`,`Haz_PCLComplianceText`,`Annual_Reporting`,`Annual_ReportingText`,`Biennial_Report`,`Biennial_ReportText`,`CCO_Registration`,`CCO_RegistrationText`,`Importation`,`ImportationText`,`Valid_ImportanceClearance`,`Valid_ImportanceClearanceText`,`Bill_Lading`,`Bill_LadingText`,`Registration_HWG`,`Registration_HWGText`,`Temp_HazStorageFacility`,`Temp_HazStorageFacilityText`,`Report_HazGenerated`,`Report_HazGeneratedText`,`Haz_WasteLabelled`,`Haz_WasteLabelledText`,`Valid_PermitTranspo`,`Valid_PermitTranspoText`,`Valid_RegTranspoTreaters`,`Valid_RegTranspoTreatersText`,`Waste_Transporter`,`Waste_TransporterText`,`Valid_CertTreatment`,`Valid_CertTreatmentText`,`Air_ValidPOA`,`Air_ValidPOAText`,`Air_EmissionPOA`,`Air_EmissionPOAText`,`Air_DisplayInstallation`,`Air_DisplayInstallationText`,`Air_PermitCondition`,`Air_PermitConditionText`,`Air_WindDevice`,`Air_WindDeviceText`,`Air_PlantOperationProblem`,`Air_PlantOperationProblemText`,`Air_CCTVInstalled`,`Air_CCTVInstalledText`,`Air_CEMSorPEMS`,`Air_CEMSorPEMSText`,`Air_YearlyRATA`,`Air_YearlyRATAText`,`Air_EmissionTestStandard`,`Air_EmissionTestStandardText`,`Air_AmbientQualityStandard`,`Air_AmbientQualityStandardText`,`Water_ValidDP`,`Water_ValidDPText`,`Water_VolumeDP`,`Water_VolumeDPText`,`Water_PermitsComplied`,`Water_PermitsCompliedText`,`Water_FlowMeterDevice`,`Water_FlowMeterDeviceText`,`Water_CertifiedSiphoning`,`Water_CertifiedSiphoningText`,`Water_ComplianceEffluent`,`Water_ComplianceEffluentText`,`Water_AmbientQualityMonitoring`,`Water_AmbientQualityMonitoringText`,`Water_PaymentWastewater`,`Water_PaymentWastewaterText`,`SWM_WasteSegregation`,`SWM_WasteSegregationText`,`SWM_WasteDisposalFacilities`,`SWM_WasteDisposalFacilitiesText`,`PCO_Guidelines`,`PCO_GuidelinesText`,`DAO_SMRSubmission`,`DAO_SMRSubmissionText`,`EIS_System`,`EISS_Data`,`Chemical_Management`,`Chemical_Management_Data`,`HW_Management`,`HW_Management_Data`,`AQ_Management`,`AQ_Management_Data`,`WQ_Management`,`WQ_Management_Data`,`SW_Management`,`SW_Management_Data`,`Commitment_TechCon`,`Commitment_TechCon_Data`,`Rec_ConfirmatorySampling`,`Rec_ConfirmatorySampling_Data`,`Rec_TempPtoDp`,`Rec_TempPtoDp_Data`,`Rec_PcoSem`,`Rec_PcoSem_Data`,`Rec_SMRCMR_Submission`,`Rec_SMRCMR_Submission_Data`,`Rec_NOMTC`,`Rec_NOMTC_Data`,`Rec_NOVIssuance`,`Rec_NOVIssuance_Data`,`Rec_Issuance5DayCDO`,`Rec_Issuance5DayCDO_Data`,`Rec_EndorsementPAB`,`Rec_EndorsementPAB_Data`,`OtherRecommendations`,`OtherRecommendations_Data`,`targetPath`,`uniqueid`,`Inspector`,`SecondaryInspector`,`Checkedby`,`SectionChief`,`DivisionChief`,`RegionalDirector`,`datecreated`,`userid`)
	VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,$userid)";
	...
	public function fetchData($project_id) {
		...
		SELECT
			...
			Latitude,
			Longitude, 
			MAX(tblhwgid.PermitNumber) as HWGID_PermitNumber,
			MAX(tblhwgid.IssuanceDate) AS HWGID_IssuanceDate, 
			MAX(tblhwgid.ExpirationDate) AS HWGID_ExpirationDate, 
			MAX(tbltsd.PermitNumber) AS TSD_Permitnumber,
			MAX(tbltsd.IssuanceDate) AS TSD_IssuanceDate,
			MAX(tbltsd.ExpirationDate) AS TSD_ExpirationDate,
			MAX(tblpto.PTOCode) AS PTO_PTOCode,
			MAX(tblpto.IssuanceDate) AS PTO_IssuanceDate, 
			MAX(tblpto.ExpirationDate) AS PTO_ExpirationDate,
			MAX(tbldp.WWDPCode) as DP_WWDPCode, 
			MAX(tbldp.IssuanceDate) as DP_IssuanceDate, 
			MAX(tbldp.ExpirationDate) as DP_ExpirationDate,
			MAX(tblpco.PCOName) as PCO_PCOName, 
			MAX(tblpco.PCOCode) as PCO_PCOCode,
			MAX(tblpco.ContactNo) as PCO_ContactNo
		FROM 
			tblprojects 
		LEFT JOIN 
			tblhwgid ON tblprojects.ForeignKey = tblhwgid.ForeignKey 
		LEFT JOIN 
			tblpto ON tblprojects.ForeignKey = tblpto.ForeignKey 
		LEFT JOIN 
			tbltsd ON tblprojects.ForeignKey = tbltsd.ForeignKey 
		LEFT JOIN 
			tbldp ON tblprojects.ForeignKey = tbldp.ForeignKey
		LEFT JOIN 
			tblpco ON tblprojects.ForeignKey = tblpco.ForeignKey
		WHERE 
			tblprojects.ID = {$project_id}
		GROUP BY
			tblprojects.ID,
			ProjectName, 
			ReferenceNo,
