            ...
            <div class="card card-primary">
              ...
              <form id="updateproject-form">
                <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-2">
                        ...
                        <input type="date" name="approved-date" class="form-control" id="approved-date" placeholder="Date Approved">
                      </div>
                    ...
                    <div class="row">
                      <div class="form-group col-md-5">
                        ...
                        <input type="text" name="latitude-input" class="form-control" id="latitude-input" placeholder="Latitude">
                      </div>
                      <div class="form-group col-md-5">
                        <label for="longitude-input">Longitude</label>
                        <input type="text" name="longitude-input" class="form-control" id="longitude-input" placeholder="Longitude">
                      </div>
                      <div class="form-group col-md-2">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-block btn-warning"><i class="far fa-paper-plane"></i> Save Changes</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-between">
          ...
          <button type="button" class="btn btn-warning" id="button-map-confirm"><i class="fas fa-check"></i> Confirm Geocoordinates</button>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
...
<!-- ./wrapper -->
    ...
    <!-- Modals -->
    <div class="modal fade" data-backdrop="static" id="modal-prompt" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title text-success">Record Updated</h4>
            </div>
            <div class="modal-body">
              <p>Record successfully updated. You will be redirected to Project List. Click Confirm to continue.</p>
            </div>
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-success btn-block" id="button-prompt">CONFIRM</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
...
<script src="../../build/js/updateproject.js"></script>
...
<script async
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD5nv80uHwanjFnoxtvfTYJXRX_SkUIgwk&callback=initMap">
</script>
</body>
</html>
