  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Project Classifications</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../index.php">Home</a></li>
              <li class="breadcrumb-item active">Project Classifications</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><small>Categories</small></h3>
              </div>
              <!-- /.card-header -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div id="project-class" style="zoom: 75%;"></div>
                    </div>
                    <div class="col-md-2"></div>
                </div>
                </div>
...
<script src="../../build/js/projectclass.js"></script>
<script>
