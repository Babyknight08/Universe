            ...
            <div class="card card-primary">
              ...
              <form id="updateuser-form">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <select class="form-control select2" style="width: 100%;" id="section-select" required>
                          <option selected="selected" value="0">Waste Water Permitting Section</option>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary"><i class="far fa-paper-plane"></i> Save Changes</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
...
<!-- ./wrapper -->
      <!--DUMMY BUTTON TO SIMULATE FIRING OF MODAL BECAUSE SOME WEIRD ASS SHIT IS PREVENTING THE MODAL FROM DISPLAYING CORRECTLY
          WHEN TRIGGERED WITH $(id).show()-->
      <button id="button-dummy" type="button" style="display:none;" data-toggle="modal" data-target="#modal-success"></button>
      <!------------------------------------------------->
      <div class="modal fade" data-backdrop="static" id="modal-success" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title text-success">User Updated</h4>
            </div>
            <div class="modal-body">
              <p>Employee information has been updated!</p>
            </div>
            <div class="modal-footer justify-content-between">
              <a href="userlist.php" class="btn btn-success" id="button-reset">OK</a>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
...
<script src="../../build/js/updateuser.js"></script>
